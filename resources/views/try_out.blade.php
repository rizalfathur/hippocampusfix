    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-8">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-1"><button type="button" class="btn btn-secondary">Back</button></div>
                <div class="col-md-1 text-center mt-2">1</div>
                <div class="col-md-1"><a href="{{ url('/try_out2')}}"><button type="button" class="btn btn-secondary">Next</button></a></div>
